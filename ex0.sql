/* SQLZOO: 0 SELECT basics:
http://sqlzoo.net/wiki/SELECT_basics */

/* Ex1. The example uses a WHERE clause to show the population of 'France'. 
...
Modify it to show the country and the area for countries with an area between 
200,000 and 250,000. */
SELECT name, area
FROM world
