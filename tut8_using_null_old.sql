...
/* Ex1. One MSP was kicked out of the Labour party and has no party. Find him.
...
/* Ex2. Obtain a list of all parties and leaders. */
SELECT name, leader
FROM party


/* Ex3. Give the party and the leader for the parties which have leaders. */
SELECT name, leader
FROM party
WHERE leader IS NOT NULL


/* Ex4. Obtain a list of all parties which have at least one MSP. */
SELECT p.name
...
/* Ex5. Obtain a list of all MSPs by name, give the name of the MSP and the name of 
the party where available. Be sure that Canavan MSP, Dennis is in the list. 
...
/* Ex6. Obtain a list of parties which have MSPs, include the number of MSPs. */
...
/* Ex7. A list of parties with the number of MSPs; include parties with no MSPs. */
SELECT p.name, COUNT(m.name)
